...
while True:
    ...
    answer = model.query(encoded_image, "is this a soldier? Answer either with TRUE or FALSE do not elaborate. You are giving us a simple one word answer and nothing else.")["answer"]
